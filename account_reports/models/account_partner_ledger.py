...
class ReportPartnerLedger(models.AbstractModel):
    ...
    def _get_query_amls(self, options, expanded_partner=None, offset=None, limit=None):
        ...
        query = '''
            ...
            LEFT JOIN account_payment ap                ON account_move_line__move_id.id=ap.move_id 
            LEFT JOIN account_payment_group apg         ON ap.payment_group_id =apg.id
            WHERE %s
            ORDER BY account_move_line.date, account_move_line.id
